...
with st.sidebar:
    ...
    with st.expander("❓ Help & Tips"):
        st.markdown("""
        **Getting Started:**
        1. Choose your interview style and settings
        2. Describe what you want to prepare for
...
if not OPENAI_API_KEY:
    st.error("⚠️ OpenAI API key not found. Please add `OPENAI_API_KEY` to your `.env` file and restart the app.")
    st.stop()
